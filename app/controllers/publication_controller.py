...
from app.crud.publication_crud import submit_publication_db
...
def submit_publication_controller(main_docx, supporting_image, first_name, last_name, email, submission_type, publication_title,author_bio):
    try:
        ...
        status = submit_publication_db(docx_path, db_img_path, first_name, last_name, email, submission_type, publication_title, author_bio)
        if status:
